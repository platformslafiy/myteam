...
const TR: Dict = {
  ...
  "plan.editTooltip": "Detayları düzenle",
  "plan.historyTooltip": "Geçmiş / aksiyon gir",
  "hist.title": "Aksiyon Geçmişi",
  "hist.subtitle": "{title} için adım adım yapılan işler",
  "hist.add": "Aksiyon ekle",
  "hist.date": "Tarih",
  "hist.note": "Ne yapıldı?",
  "hist.notePh": "Bugün/bu tarihte ne yaptığınızı yazın…",
  "hist.progress": "İlerleme (%)",
  "hist.empty": "Henüz aksiyon kaydı yok. İlk adımı ekleyin.",
  "hist.save": "Kaydet",
  "hist.by": "{who}",
  "toast.logSaved": "Aksiyon kaydedildi",
  "toast.logDeleted": "Aksiyon silindi",
  "toast.logFail": "Aksiyon işlemi başarısız",
...
const EN: Dict = {
  ...
  "plan.editTooltip": "Edit details",
  "plan.historyTooltip": "History / log action",
  "hist.title": "Activity history",
  "hist.subtitle": "Step-by-step work done on {title}",
  "hist.add": "Add activity",
  "hist.date": "Date",
  "hist.note": "What was done?",
  "hist.notePh": "Describe what you did on this date…",
  "hist.progress": "Progress (%)",
  "hist.empty": "No activity yet. Add the first step.",
  "hist.save": "Save",
  "hist.by": "{who}",
  "toast.logSaved": "Activity saved",
  "toast.logDeleted": "Activity deleted",
  "toast.logFail": "Activity operation failed",
